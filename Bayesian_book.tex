...
\begin{table}[htbp]
  \centering
  \caption{A Bayes' box showing how to calculate the posterior for the case of drawing balls from an urn containing 5 red and white balls.}\label{tab:Prior_bayesBoxDiscreteUrns}
    \begin{tabular}{ccccc}
    \toprule
...
We suppose that previous studies have suggested that the prevalence of this disease is closer to 5\% within the population. To illustrate the effect of an overly simplistic prior we choose a triangular prior of the form shown in figure \ref{fig:Prior_disease}, which is peaked at 5\%\footnote{We will later use the more appropriate beta distribution after it has been introduced in chapter \ref{chap:distributions}.}.
...
\chapter{The difficulty is in the denominator}
