...
\subsection{An urn of balls\footnote{Taken from Bolstad's great introduction to Bayesian statistics \cite{bolstad2007introduction}.}}
...
We can then illustrate the functioning of Bayes' rule in the \textit{Bayes' box} shown in figure \ref{fig:Prior_bayesBoxDiscreteUrns}. In this case the application of the discrete form Bayes' rule takes the following form:
