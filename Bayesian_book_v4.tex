...
\section{Chapter mission statement}
This chapter introduces the reader to one of the most common algorithms used in MCMC sampling, that of the \textit{Random Walk Metropolis} algorithm. Furthermore, after reading this chapter the reader should understand the methods used to judge convergence of such an algorithm.
