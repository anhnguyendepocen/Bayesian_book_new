...
\subsection{Rewriting our problem in the language of Statistical Mechanics\footnote{Here we follow a derivation similar to that by Neal in \cite{brooks2011handbook}.}}
...
\section{Getting setup with Stan using RStan}
...
\sigma &\sim gamma(1,1)
\end{align}
The completed Stan programme is shown below.
...
\subsubsection{Writing and executing a Stan programme}
...
\subsubsection{Packaging data}
\subsubsection{Marginalising out discrete parameters}
...
\subsubsection{Calculating LOO-CV and WAIC}
