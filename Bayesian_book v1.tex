...
Let's assume that you have been shown by a security camera to have definitely been in the same house as the victim - Sally - on the night of their demise. Let's also assume that, in this bizarre legal framework, that the jury starts off by assuming \textit{guilt}, rather than innocence.
...
In (\ref{eq:Intro_murder}) we have implicitly assumed that the security camera is hidden, and hence the murderer does not alter his behaviour to avoid being seen. 
