...
\section{Exchangeability vs random sampling}
...
\caption{Binomial likelihoods for the event that 5 (blue), 2 (red), and 9 (grey) volunteers recovered in the week period. The maximum likelihood estimates are shown as dotted lines for each of the cases.}\label{fig:Distributions_binomialClinicalTrial}
\end{figure}
