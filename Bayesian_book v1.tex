...
\sum\limits_{X_A=0}^{1}\sum\limits_{X_B=0}^{1} p(X_A,X_B) = 0.3 + 0.1 + 0.1 + 0.5 = 1
\end{equation}
...
\begin{table}[htbp]
  \centering
    ...
    \toprule
          &       & \multicolumn{2}{c}{\textbf{Coin A}} &  \\
    \midrule
          &       & \textbf{0} & \textbf{1} & \multicolumn{1}{c}{\textbf{$p(X_B)$}} \\
    ...
    \multicolumn{1}{c}{} & \multicolumn{1}{c}{\textbf{1}} & 0.1   & 0.5   & \multicolumn{1}{c}{\textbf{0.6}} \\
          & \multicolumn{1}{c}{\textbf{$p(X_A)$}} & \textbf{0.4} & \textbf{0.6} & \multicolumn{1}{c}{} \\
    \bottomrule
    \end{tabular}%
...
p(X_A=1) = p(X_A=1,X_B=0) + p(X_A=1,X_B=1)
\end{equation}
...
p(A=\alpha) = \sum\limits_{\beta} p(A=\alpha,B=\beta)
\end{equation}
...
\begin{equation}
\begin{align}
p(X_B=0) &= \sum\limits_{\alpha=0}^{1} p(X_B=0,X_A=\alpha)\\
&= p(X_B=0,X_A=0) + p(X_B=0,X_A=1)\\
&= 0.3 + 0.1 = 0.4
\end{align}
\end{equation}
...
&= \frac{p(X_A=1,X_B=1)}{p(X_A=1,X_B=0)+p(X_A=1,X_B=1)}\\
&= \frac{0.5}{0.1 + 0.5}\\ 
&= \frac{5}{6}
\end{align}
\end{equation}

In (\ref{eq:Intro_conditionalDiscreteCoins}), we have used the rule we discussed earlier for calculating marginal probabilities, shown in (\ref{eq:Intro_marginalDiscreteProbabilityTwoDimensions}), to calculate the denominator, $p(X_A=1)$.
...
\begin{table}[htbp]
  \centering
    ...
    \toprule
          &       & \multicolumn{2}{c}{\textbf{Coin A}} &  \\
    \midrule
          &       & \textbf{0} & \textbf{1} & \multicolumn{1}{c}{\textbf{$p(X_B|X_A=1)$}} \\
    ...
    \multicolumn{1}{c}{} & \multicolumn{1}{c}{\textbf{1}} & 0.1   & {\color{blue}0.5}   & \multicolumn{1}{c}{\textbf{=0.5/0.6 = 5/6}} \\
          & \multicolumn{1}{c}{\textbf{$p(X_A)$}} & \textbf{0.4} & {\color{blue}\textbf{0.6}} & \multicolumn{1}{c}{} \\
    \bottomrule
    \end{tabular}%
...
\item \textbf{The best predictions.} Leading figures both inside and outside of academia use Bayesian approaches for prediction. An example being Nate Silver's correct prediction of the 2008 US Presidential election results (insert reference).
\end{itemize}
