...
\begin{table}[htbp]
  \centering
    ...
    \toprule
          &       & \multicolumn{2}{c}{\textbf{Coin A}} &  \\
    \midrule
          &       & \textbf{0} & \textbf{1} & \multicolumn{1}{c}{\textbf{p(B)}} \\
    ...
    \multicolumn{1}{c}{} & \multicolumn{1}{c}{\textbf{1}} & 0.1   & 0.5   & \multicolumn{1}{c}{\textbf{0.6}} \\
          & \multicolumn{1}{c}{\textbf{p(A)}} & \textbf{0.4} & \textbf{0.6} & \multicolumn{1}{c}{} \\
    \bottomrule
    \end{tabular}%
...
In (\ref{eq:Intro_marginalDiscreteProbabilityTwoDimensions}), $\alpha$ and $\beta$ refer to the specific values taken on by the random variables $A$ and $B$. We can use this rule for the coin example to calculate the probability that coin B lands up on 'tails':
