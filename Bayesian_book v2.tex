...
p446 Stan manual. p 6-7 in Monte Carlo book.
Central Limit Theorem accuracy proportional to 1/sqrt(n). Choose neff so that mcmc central limit accuracy proportional to 1/sqrt(neff). cf Bob's video. Also fast fourier transforms to do this. Thinning samples.
