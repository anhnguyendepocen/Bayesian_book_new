...
\caption{The LKJ distributions over allowable correlation matrices for left: $d=2$, and right: $d=3$, when $\eta=1$, $\eta=10$ (orange), and $\eta=0.5$ (green). \textbf{Add legends}.}\label{fig:Distributions_LKJ_determinants}
\end{figure}
