...
Show performance vs Metropolis vs independent. Also show that we are able to essentially independently sample from the model if we discard half the samples. 
...
Show how Metropolis and Gibbs struggle when the posterior is very correlated. A motivation for moving to HMC. Prefer to move diagonally opposed to horizontally and vertically. 
